...
Внешние программы могут выполнять команды ОС. Для этого в регистровую пару HL нужно поместить адрес строки, в которой написана команда. Далее нужно сделать вызов по адресу <Начало кода ОС> + 3, например:<br/>
