...
`PLAY ABC*` - прроиграть мелодию из файла с именем ABC*
`PWM 0..3F` - управление ШИМ на ВИ53 27.7 кГц
...
Для воспроизведения музыки применяется схема на таймере КР580ВИ53. Такая схема реализует возможность управления амплитудой и дополнительно предоставляем один канал ШИМ:
