...
$81 - вывод следующих двух байт в формате DEC<br/>
$DF - ожидание нажатия клавиши<br/>

Следующие управляющие символы используются вместе с указателем на строку - POINTER. Такая конструкция называется шаблон.
...
Чтобы вывести на экран следующую строку каталога файлов, достаточно переместить POINTER на нужную запись и снава вызвать вывод шаблона. Так можно делать вывод записей структурированной базы данных. Аналогично в ОС реализованы шаблоны вывода дампа и вывода длины загружаемых файлов.
